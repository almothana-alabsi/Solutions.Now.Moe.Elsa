...
namespace Solutions.Now.Moe.Elsa.Activities
{
    ...
    public class ResumeProject : Activity
    {
        ...
        public ResumeProject(DesignReviewDBContext DesignReviewDBContext, SsoDBContext ssoDBContext, MoeDBContext moeDBContext)
        {
        ...
        protected override async ValueTask<IActivityExecutionResult> OnExecuteAsync(ActivityExecutionContext context)
        {
            ...
            try
            {
                ...
                ResumeProjectWork resumeProject = await _moeDBContext.ResumeProjectWork.FirstOrDefaultAsync(i => i.Serial == RequestSerial);
                    ...
                    if (resumeProject.TenderSerial != null)
                    {
 
                        ReferedTender referedTender = await _moeDBContext.ReferedTender.FirstOrDefaultAsync(i => i.Serial == resumeProject.TenderSerial);
