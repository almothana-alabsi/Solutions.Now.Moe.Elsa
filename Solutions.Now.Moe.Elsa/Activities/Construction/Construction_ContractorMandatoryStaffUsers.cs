...
namespace Solutions.Now.Moe.Elsa.Activities
{
    [Activity(
       ...
       DisplayName = "Contractor Mandatoty Staff Approval",
       Description = "Contractor Mandatoty Staff Approval in WorkflowRules Table",
       Outcomes = new[] { OutcomeNames.Done }
   )]
    public class Construction_ContractorMandatoryStaffUsers : Activity
    {
        private readonly ConstructionDBContext _ConstructionDBContext;
        private readonly SsoDBContext _ssoDBContext;
        private readonly MoeDBContext _moeDBContext;

        public Construction_ContractorMandatoryStaffUsers(ConstructionDBContext DesignReviewDBContext, SsoDBContext ssoDBContext, MoeDBContext moeDBContext)
        {
