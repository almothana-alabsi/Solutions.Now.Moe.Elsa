...
namespace Solutions.Now.Moe.Elsa.Activities
{
    [Activity(
         Category = "Approval",
         DisplayName = "projectCancellation",
         Description = "projectCancellation",
         Outcomes = new[] { OutcomeNames.Done }
     )]
    public class ProjectCancellationApproval : Activity
    {
        ...
        public ProjectCancellationApproval(DesignReviewDBContext DesignReviewDBContext, SsoDBContext ssoDBContext, MoeDBContext moeDBContext)
        {
        ...
        protected override async ValueTask<IActivityExecutionResult> OnExecuteAsync(ActivityExecutionContext context)
        {
            ...
            try
            {
                ...
                ProjectCancellation projectCancellation = await _moeDBContext.ProjectCancellation.FirstOrDefaultAsync(i => i.Serial == RequestSerial);
                    ...
                    if (projectCancellation.tenderSerial != null)
                    {
                   
                        ReferedTender referedTender = await _moeDBContext.ReferedTender.FirstOrDefaultAsync(i => i.Serial == projectCancellation.tenderSerial);
